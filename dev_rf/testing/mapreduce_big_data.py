...
def mapper(file_path: str, file_name: str, file_name2: str):
    """
    ...
    def mapper_comments(file_path: str, file_name: str):
...
df_answer_delay["start_time"] = df_answer_delay["start_time"].apply(
